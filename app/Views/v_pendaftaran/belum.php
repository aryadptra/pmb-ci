...
<main id="main">
  ...
  <section id="contact" class="contact">
    <div class="container" data-aos="fade-up">
      ...
      <p class="description">Pendaftaran dapat dilakukan mulai dari tanggal <b><?= tgl_indonesia($tgl_buka); ?></b> sampai dengan tanggal <b><?= tgl_indonesia($tgl_tutup); ?></b> melalui Aplikasi PMB Bang Ambo University</p>
    </div>
  </section>
